...
// Variables
const rootDomain = "iniluna.xyz"; // Ganti dengan domain utama kalian
const serviceName = "vcfd2-1"; // Ganti dengan nama workers kalian
const apiKey = "6eUdZsJ2q9Wobn4J3e6Tlon4eW2sA4bMqoXx2g3O"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "ezanstream@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "1fc360b2a49b9972cb346c51b6cd6ec6"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "df79fa46f82a35074787bde3c8afdf74"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
...
const PROXY_BANK_URL = "https://raw.githubusercontent.com/Dmitt0999/vcfd2/refs/heads/main/pr.txt";
